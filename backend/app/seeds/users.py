...
def seed_users():
    ...
    mila = User(
        username='mia', email='mia@aa.io', password='password', birthday="10/11/2001", banner_color="#FFFFE0", bio="this is a test...", pronouns=pronouns[2], avatar='test.png'
        )
    aurora = User(
    ...
    amaya = User(
        username='amaya', email='amaya@aa.io', password='password', birthday="04/11/2000", banner_color="#DEB887", bio="this is a test...", pronouns=pronouns[3], avatar='test.png'
        )
    ari = User(
